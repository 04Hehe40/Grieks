    ...
    while (true) {
          ...
          if (al_geweest.length === voc_woorden.length) {
            ...
            let fouten_vragen = prompt("Wil je dat de woorden die fout waren opnieuw worden ondervraagd. ja / nee")
              ...
              if(fouten_vragen == "ja" || fouten_vragen == "Ja" || fouten_vragen == "JA" || fouten_vragen == " ja" || fouten_vragen == " Ja" || fouten_vragen == " JA" || fouten_vragen == " ja " || fouten_vragen == " Ja " || fouten_vragen == " JA "){
      ...
      if(muthos1_klikken == false && muthos2_klikken == false && muthos3_klikken == false && muthos4_klikken == false && voorzetsel_klikken == false && fout_herstart == false){
...
function antwoord_geven() {
  if (index_gekozen_woord !== undefined) {
    ...
    const translation = antwoorden[voc_woorden.indexOf(gekozen_woord)];
